                ...
                <div className="lg:py-40 min-h-[650px]">
                    <div className="relative mx-auto sm:static px-6 lg:px-8">
                        <div className="max-w-xl text-start">
                            ...
                            <p className="line-clamp-3 text-lg text-grey-500">
                                {product.description}
                            </p>
                            ...
                            <div className="hidden lg:block absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8  ">
                                <div className="flex items-center space-x-6 md:space-x-8">
                                   ...
                                   <div className="w-72 h-80 overflow-hidden rounded-lg border border-secondary transform rotate-3 translate-x-4 hover:-rotate-6 hover:traslate-x-8 transition-traansform duration-300 ease-linear">
                                        <img src={product.images[0]} alt="img-hero" className="h-full w-full object-cover object-center" />
                                    </div>
                                    <div className="w-72 h-80 overflow-hidden rounded-lg border border-secondary transform rotate-3 translate-x-4 hover:-rotate-6 hover:traslate-x-8 transition-traansform duration-300 ease-linear">
                                        <img src={product.images[1]} alt="img-hero" className="h-full w-full object-cover object-center" />
                                    </div>
                                    </div> 
                                    <div className="grid flex-shrink-0 grid-cols-1 gap-y-12">
                                   <div className="w-72 h-80 overflow-hidden rounded-lg border border-secondary transform rotate-3 translate-x-4 hover:-rotate-6 hover:traslate-x-8 transition-traansform duration-300 ease-linear">
                                        <img src={product.images[2]} alt="img-hero" className="h-full w-full object-cover object-center" />
                                    </div>
                                    <div className="w-72 h-80 overflow-hidden rounded-lg border border-secondary transform rotate-3 translate-x-4 hover:-rotate-6 hover:traslate-x-8 transition-traansform duration-300 ease-linear">
                                        <img src={product.images[3]} alt="img-hero" className="h-full w-full object-cover object-center" />
                                    </div>
                                    </div> 
                                </div>
                            </div>
