...
export async function getServerSideProps(context) {
  ...
  console.log("Context Query: ", context.query); // Log the entire context.query

  const { idl } = context.query;

  console.log("Product ID: ", idl); // Log the product ID

  const product = await Product.findById(idl);
